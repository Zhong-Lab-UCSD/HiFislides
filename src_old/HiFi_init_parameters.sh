...
BIN_DIR=/mnt/extraids/SDSC_NFS/rcalandrelli/HiFi/data/src/bin
N_THREADS=32
...
##### sysbionova
OUT_DIR=/mnt/SDSC_NFS/rcalandrelli/HiFi/data/IGM
BIN_DIR=/mnt/SDSC_NFS/rcalandrelli/HiFi/data/src/bin
N_THREADS=32

SAMPLE_NAME=HiFi_cortex_AD_2

# Flowcell and surface identifiers
L1_DIR=/mnt/SDSC_NFS/rcalandrelli/HiFi/data/barcodes/AAANLCHHV_1_1 # directory of the spatial barcodes
